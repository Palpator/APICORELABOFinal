...
namespace APIFilmLabo
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient(typeof(MoviesRepository));
            services.AddTransient(typeof(PersonRepository));
            services.AddTransient(typeof(CastingRepository));
            services.AddTransient(typeof(CommentariesRepository));
            services.AddTransient(typeof(UtilisateurRepository));
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "APIFilmLabo", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "APIFilmLabo v1"));
            }
